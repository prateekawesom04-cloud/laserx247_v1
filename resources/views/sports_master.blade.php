...
@section('body')
    <div class="container-fluid">
        <div class="d-flex">
                    ...
                    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('images/bnr1.png') }}" class="d-block w-100 img-fluid"
                                    alt="Hero Image 1">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('images/bnr2.png') }}" class="d-block w-100 img-fluid"
                                    alt="Hero Image 2">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('images/bnr3.png') }}" class="d-block w-100 img-fluid"
                                    alt="Hero Image 3">
                            </div>
                        </div>
                    </div>
            ...
            <!-- Right Sidebar (30%) -->
            <div class="bg-light p-2 flex-fill">
