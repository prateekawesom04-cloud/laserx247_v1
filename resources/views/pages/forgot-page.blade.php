    ...
    <div class="row justify-content-center">
      <div class="col-md-10 col-lg-8 rounded-4 shadow-lg overflow-hidden bg-dark">
        <div class="row g-0">
          ...
          <!-- Left Side Image -->
          <div class="col-md-5 d-flex flex-column align-items-center justify-content-center text-center p-4 bg-dark text-white">
          ...
          <div class="col-md-7 p-4 text-white bg-dark">
            <form id="ForgotForm">
              ...
              <!-- Submit Button -->
              <button type="submit" class="btn btn-info text-white fw-bold w-100 mb-3">Update Password</button>
