    ...
    <div class="app_index p-3 bg-gray-300">
        <div class="container">
            <div class="row p-3">
                ...
                <div class="col-md-6 d-flex flex-column p-2 mt-5">
                    <!-- Banner -->
                    <div class="app_banner w-100 mb-3">
                    ...
                    <div class="d-flex flex-column w-100 rounded-lg bg-white shadow mb-3">
                        <div class="d-flex flex-row justify-content-between border-b border-1 border-gray-200b px-3 py-1">
