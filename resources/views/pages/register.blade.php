...
<body class="vh-100 d-flex align-items-center justify-content-center"
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-10 col-lg-8 rounded-4 shadow-lg overflow-hidden" style="background: #0a2345;">
                <div class="row g-0">
                    ...
                    <div class="col-12 col-md-7 p-4 text-white" style="background: #0a2345;">
                        ...
                        <div class="input-group mb-3 flex-wrap">
                            ...
                            <button class="btn btn-dark mt-2 mt-md-0" type="button">Get OTP</button>
                        </div>
                        ...
                        <div class="text-end mb-3">
                            <a href="javascript:void(0)" class="small text-info">Have a referral code?</a>
                        </div>

                        <!-- Register -->
                        <button class="btn btn-dark w-100 mb-3" type="button">Register</button>

                        <div class="text-center small mb-2">Get Your Ready-Made ID From WhatsApp</div>

                        <!-- WhatsApp -->
                        <button class="btn btn-success w-100 mb-3" type="button">📱 WhatsApp Now</button>
