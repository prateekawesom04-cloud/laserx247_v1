        ...
        <form id="createAccountForm">
            ...
            <div class="card mb-4 shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label for="username" class="form-label fs-6 fw-semibold">
                                <i class="fas fa-user me-1 text-success"></i> User Name
                            </label>
                            <input id="username" type="text" class="form-control form-control-lg border-2" required>
                        </div>
                        <div class="col-md-6">
                            <label for="referenceName" class="form-label fs-6 fw-semibold">
                                <i class="fas fa-user-friends me-1 text-success"></i> Reference Name
                            </label>
                            <input id="referenceName" type="text" class="form-control form-control-lg border-2">
                        </div>
                        <div class="col-md-6">
                            <label for="password" class="form-label fs-6 fw-semibold">
                        ...
                        <div class="col-md-6">
                            <label for="confirmPassword" class="form-label fs-6 fw-semibold">
            ...
            <div class="card mb-4 shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label for="maxBet" class="form-label fs-6 fw-semibold">
                        ...
                        <div class="col-md-6">
                            <label for="maxProfit" class="form-label fs-6 fw-semibold">
            ...
            <div class="card mb-4 shadow-sm border-0">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        <div class="col-md-4">
                            <label for="creditRef" class="form-label fs-6 fw-semibold">
                                <i class="fas fa-credit-card me-1 text-dark"></i> Credit Reference
                            </label>
                            <input id="creditRef" type="text" class="form-control form-control-lg border-2">
                        </div>
                        <div class="col-md-4">
                            <label for="deposit" class="form-label fs-6 fw-semibold">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input id="deposit" type="number" class="form-control border-2 text-center fw-bold">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label for="depositRemark" class="form-label fs-6 fw-semibold">
                                <i class="fas fa-comment me-1 text-dark"></i> Deposit Remark
                            </label>
                            <input id="depositRemark" type="text" class="form-control form-control-lg border-2">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <label for="masterPassword" class="form-label fs-6 fw-semibold">
